...
if not errorlevel 1 goto :control_ready

echo [1/3] Dang khoi dong bo dieu khien Tool tren cong 8090...
if exist "%PYTHONW_EXE%" (
    start "" "%PYTHONW_EXE%" tool_control.py
) else (
    start "" /min "%PYTHON_EXE%" tool_control.py
)
...
echo [2/3] Dang khoi dong may chu Dashboard Tool V1 tren cong 8088...
if exist "%PYTHONW_EXE%" (
...
echo [3/3] Dang mo giao dien Dashboard...
